#!/usr/bin/env python3
"""
Kraken RF Sentinel ML Experiment 002
...
def main():
    ...
    assignments.to_csv(
        OUT_DIR / "experiment_002_assignments.csv",
        index=False,
    )

    silhouette_df.to_csv(
        OUT_DIR / "experiment_002_silhouette.csv",
        index=False,
    )
    ...
    loadings.to_csv(
        OUT_DIR / "experiment_002_pca_loadings.csv"
    )
    ...
    ax.set_title(
        "Hardsignal Labs — Kraken RF Sentinel ML Experiment 002"
    )
    ax.legend()
    ...
    fig.savefig(
        OUT_DIR / "experiment_002_pca.png",
        dpi=180,
    )
    ...
    # ---------------------------------------------------------
    print("=" * 70)
    print("HARDSIGNAL LABS — SENTINEL ML EXPERIMENT 002")
    print("=" * 70)
    ...
    print()
    print("outputs:")
    print("  results/ml/experiment_002_assignments.csv")
    print("  results/ml/experiment_002_silhouette.csv")
    print("  results/ml/experiment_002_pca_loadings.csv")
    print("  results/ml/experiment_002_pca.png")
